...
Platy Syncer for Etsy is a lightweight syncer which provides [Woocommerce Integration for Etsy](https://platycorp.com). It is designed to be simple and effective.
...
== Features ==
[Woocommerce Integration for Etsy](https://platycorp.com) Product syncing: Sync and update simple and variable products.
[Woocommerce Integration for Etsy](https://platycorp.com) Product images: Sync product images.
...
[Woocommerce Etsy Stock](https://platycorp.com) management. Sync with shop stock or fixed quantity.
...
== Advanced Features ==
The following [Woocommerce Etsy Integration](https://platycorp.com) advanced features are available:
...
== Pro Features ==
[Etsy to Woocommerce](https://platycorp.com) Order Syncing – Sync orders from Etsy to your Woocommerce order table manually or automatically.
[Etsy Woocommerce](https://platycorp.com) Auto Stock Syncing – 2-way auto stock syncing.
Attribute Syncing – You sync product attributes to Etsy.

== Future Features ==
I list future features which I intend to support. If anyone is particularly interested in these features, I am available for a chat to see how we can implement these feature for you in stages, and in the end release them as features for the plugin.
* Product import - from Etsy to Woocomerce.
* Accounting information - better formatting of orders imported from Etsy, so you can easily take them to use for accounting purposes. I know that this has been asked many times, but I have yet to undertake this.
...
== Changelog ==
= 6.4.7 =
* status updates only if changed

= 6.4.0 =
* Fix: 9 images threw an error when 10 are allowed.

= 6.3.3 =
* added remote logging

= 6.3.2 =
* fixing stock synchronization bug

= 6.3.1 =
* Starting to add some support for multilingual sites

= 6.3.0 =
* Updating stock status on stock syncing

= 6.2.7 =
* product syncing error fix

= 6.2.6 =
* Changed 2023 when made limit to 2024

= 6.2.5 =
* Fixed bug to enable Etsy actions such as completing orders
